...
@Slf4j
public class BookerIdAndStatusRejectedOrderByStartDescHandler extends BookingSearcher {
    public BookerIdAndStatusRejectedOrderByStartDescHandler(BookingRepository bookingRepository) {
